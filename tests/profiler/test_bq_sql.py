...
from bq_profile.profiler import bq_sql


class AggregateTestCase(unittest.TestCase):
    def test_bq_sql_aggregate_integer(self):
        project = 'project'
        ...
        actual = bq_sql.aggregate(f, table_ref, i, '""')

        self.assertEqual(actual, expected)

    def test_bq_sql_aggregate_numeric(self):
        project = 'project'
        dataset_id = 'dataset_id'
        table_id = 'table_id'
        name = 'name'
